...
| `docs/stage-1-acceptance.md` 到 `docs/stage-24-acceptance.md` | 每阶段交付、验收、面试表达 |
...
3. `src/main/java/com/eventrush/service/TicketingService.java`
4. `src/main/java/com/eventrush/service/AsyncGrabService.java`
5. `src/main/java/com/eventrush/service/TicketOrderRepository.java`
6. `src/main/resources/lua/grab-ticket.lua`
7. `src/main/java/com/eventrush/api/TraceFilter.java`
8. `src/test/java/com/eventrush/service/TicketingServiceTest.java`

看完这 8 个文件，至少能把项目主线、库存、幂等、MQ、接口治理讲清楚。
